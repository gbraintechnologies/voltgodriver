...
export default function SecurityScreen() {
  ...
  const handleDeactivate = () => setDeactivateVisible(true);
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.toggleRow}>
          <View style={styles.rowLeft}>
            <View style={styles.iconCircle}>
              <SvgXml xml={fingerprintSvg} width={22} height={22} />
            </View>
            <View>
        ...
        <View style={styles.toggleRow}>
          <View style={styles.rowLeft}>
            <View style={styles.iconCircle}>
              <SvgXml xml={bellSvg} width={20} height={22} />
            </View>
            <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => toast.info("Change PIN — coming soon.")}
          activeOpacity={0.75}
        >
          <View style={styles.rowLeft}>
            <View style={styles.iconCircle}>
              <SvgXml xml={lockSvg} width={18} height={22} />
            </View>
        ...
        <TouchableOpacity
          style={styles.menuRow}
          onPress={() => toast.info("Active Sessions — coming soon.")}
          activeOpacity={0.75}
        >
          <View style={styles.rowLeft}>
            <View style={styles.iconCircle}>
              <SvgXml xml={deviceSvg} width={18} height={22} />
            </View>
      ...
      <ConfirmModal
        ...
        message="This will permanently deactivate your rider account. All earnings must be withdrawn first. Continue?"
        primaryLabel="Deactivate"
        onPrimary={confirmDeactivate}
        secondaryLabel="Cancel"
        onSecondary={() => setDeactivateVisible(false)}
        danger
      />
    </SafeAreaView>
  );
